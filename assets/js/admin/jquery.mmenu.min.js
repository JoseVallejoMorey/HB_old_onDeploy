...
!function (e) {
    function s(s, n, t) {
        ...
        for (var o = [
            ...
            'modal',
            'moveBackground'
        ], l = 0, d = o.length; d > l; l++) 'undefined' != typeof s[o[l]] && (e[a].deprecated('The option "' + o[l] + '"', 'offCanvas.' + o[l]), s.offCanvas = s.offCanvas || {
    ...
    function n(s) {
        ...
        for (var n = [
            ...
            'label',
            'spacer'
        ], t = 0, i = n.length; i > t; t++) 'undefined' != typeof s[n[t] + 'Class'] && (e[a].deprecated('The configuration option "' + n[t] + 'Class"', 'classNames.' + n[t]), s.classNames[n[t]] = s[n[t] + 'Class']);
        ...
        }, s.classNames.labels.collapsed = s.collapsedClass), 'undefined' != typeof s.header) for (var n = [
            'panelHeader',
            'panelNext',
            'panelPrev'
        ], t = 0, i = n.length; i > t; t++) 'undefined' != typeof s.header[n[t] + 'Class'] && (e[a].deprecated('The configuration option "header.' + n[t] + 'Class"', 'classNames.header.' + n[t]), s.classNames.header = s.classNames.header || {
        ...
        for (var n = [
            ...
            'menuWrapperSelector',
            'menuInjectMethod'
        ], t = 0, i = n.length; i > t; t++) 'undefined' != typeof s[n[t]] && (e[a].deprecated('The configuration option "' + n[t] + '"', 'offCanvas.' + n[t]), s.offCanvas = s.offCanvas || {
    ...
    if (!e[a]) {
        ...
        e[a].prototype = {
            ...
            _update: function (e) {
                ...
                ]), 'function' == typeof e) this.updates.push(e);
