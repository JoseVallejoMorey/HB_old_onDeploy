...
*/
    protected $options = array(
        ...
        'text_next' 					=> 'Siguiente &raquo;',
        'text_first' 					=> '&laquo; Primera',
        'text_last' 					=> 'Ultima &raquo;',
        'text_ellipses' 				=> '...',
...
*/				
			//var_dump($this->query);
			//var_dump($this->options['db_handle']);
...
*/
    public function build_li_element($class, $text, $is_link = false, $page_number = 0)
    {
        ...
        {
            $this->links_html .= '<li rel="'.$page_number.'" class="'.$class.'">
				<a href="'.$this->build_link_url($page_number).'">'.$text.'</a></li>'.PHP_EOL;
        }
    }
